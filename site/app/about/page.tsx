        ...
        <div className="space-y-6 text-[#413d57] leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-4">
              ...
              <li><strong className="text-inktext">Standard mileage rate:</strong> We use the standard IRS mileage rate for business driving (67 cents per mile). (Source: <a href="https://www.irs.gov/tax-professionals/standard-mileage-rates" className="text-accent-deep hover:underline font-medium">IRS Mileage Rates</a>)</li>
              <li><strong className="text-inktext">Federal income tax:</strong> We apply the 2026 federal marginal tax brackets to your estimated taxable income after accounting for the standard deduction ($15,000 Single / $30,000 Married) and the simplified QBI deduction.</li>
            </ul>
          </div>
