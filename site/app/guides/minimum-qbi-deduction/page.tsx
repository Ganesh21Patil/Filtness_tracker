...
export default function GuideQbiMinimum() {
  return (
    <ArticleShell
      breadcrumbs={[{ label: "Guides", href: "/guides" }, { label: "The minimum QBI deduction" }]}
      title="The minimum QBI deduction, explained"
      image={guideQbi}
      footer={
        <>
          See also our <Link href="/about">methodology</Link>, which documents exactly how the QBI figure is calculated. Last updated: September 2026.
        </>
      }
    >
