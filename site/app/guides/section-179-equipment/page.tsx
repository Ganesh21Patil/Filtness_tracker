    ...
    <main className="flex-1 bg-ink py-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto bg-cream text-inktext p-6 sm:p-10 rounded-[28px] shadow-[0_18px_50px_rgba(31,25,74,.1)]">
        ...
        <div className="space-y-6 text-[#413d57] leading-relaxed">
          ...
          <p>Enter your total qualifying equipment spend in the <Link href="/deductions" className="text-accent-deep hover:underline">Equipment field</Link> of the calculator — the tool already treats it as fully deductible the year you enter it, consistent with Section 179.</p>
