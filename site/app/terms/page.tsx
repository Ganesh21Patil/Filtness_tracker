    ...
    <main className="flex-1 bg-ink py-16 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto bg-cream text-inktext p-6 sm:p-10 rounded-card shadow-card">
        ...
        <div className="space-y-6 text-inksoft leading-relaxed">
          ...
          <p className="text-sm text-inkmuted font-medium border-t border-line pt-4">Last updated: September 2026. See also our <Link href="/privacy" className="text-accent-deep hover:underline font-medium">privacy policy</Link>.</p>
        </div>
      </div>
    </main>
  );
